...
# without the submodule checked out; test_theme reads the sheet and fails on any drift.
...
# Ordered: modest, substantial, extreme, by how far AI goes, so an ordered ramp and not the four
# brand curves, which are categorical. The middle step IS --ark-blue; the ends travel from it in
# lightness and a little in hue, which is what reaches OKLab 17.9 and 16.1 between neighbours
# against the 15 this palette holds to. A single-hue ramp off --ark-blue reaches only 11.
